...
TESTDB_TGKEY=`grep -H  "\-\-gp\-c " /var/tmp/db_dumps/$TGDATE/*.rpt | grep dev |awk -F":" '{print $1}' | tail -1 | awk -F"gp_dump_" '{print $2}' | awk -F".rpt" '{print $1}'`
...
#echo "GP:WARNING dev,Backup is failed,error"
